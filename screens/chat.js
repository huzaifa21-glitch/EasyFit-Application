  ...
  useEffect(() => {
    if (isFocused) {
      ...
      getDataFromScreenA().then(() => {
        ...
        axios
          .post("https://amused-handkerchief-seal.cyclic.app/loadchats", {
            userdata,
          })
          ...
          .then((response) => {
            if (response.data == "0") {
              ...
              chatheadsfinal = chatheadsfinal.reverse();
              setIsLoading(false);
            }
          })
          .catch((error) => {
        ...
        >
          ...
          >
            <Text style={styles.title1}>
              You cannot send or recieve messages right now!
            </Text>
            <Text style={styles.title2}>
              {" "}
              You will recieve messages when someone buys your course
            </Text>
          </View>
        </View>
      );
