...
const Course = ({ navigation }) => {
  ...
  React.useEffect(() => {  
    ...
    axios.post('https://amused-handkerchief-seal.cyclic.app/displaycourse',{formdata},{maxContentLength: 1000000})
    .then(response => {
  ...
  const dt=d+" "+t;
    ...
    console.log("OK");
      ...
      axios
      .post(
        "https://amused-handkerchief-seal.cyclic.app/newmessage",{newmessage}
      )
      .then((response) => {
        if (response.data == "0") {
          ...
          alert("Course Succesfully Purchased! \nChat Initiated Please procceed to Chatbox")
       }
      })
      .catch((error) => {
    ...
    <ScrollView style={styles.container}>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.display3}>
          ...
          >
            <Text style={Globalstyles.buttonText}>Buy Course</Text>
          </Pressable>
        </View>
      </SafeAreaView>
    </ScrollView>
