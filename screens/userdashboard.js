...
const USRDASH = ({ navigation, route }) => {
  ...
  React.useEffect(() => {
    ...
    const getDataFromScreenA = async () => {
      try {
        ...
        axios
          .post(
            "https://amused-handkerchief-seal.cyclic.app/dashName",
            { email },
        ...
        axios
          .post(
            "https://amused-handkerchief-seal.cyclic.app/totalCalories",
            { email },
            { maxContentLength: 1000000 }
          )
          .then((response) => {
            ...
            //Daliy Calories
            totalCalories11 = totaldata[0].totalcalories;
        ...
        try {
          ...
          axios
            ...
            .then((response) => {
              ...
              console.log(totalCalories11);
              console.log(achCalories1);
              console.log(currentCalories1);
  ...
  const recentSubmit = () => {
    if (err == 0) {
      ...
      axios
        .post("https://amused-handkerchief-seal.cyclic.app/addrecentmeals", { data })
        .then((response) => {
          // console.log(response);
          // navigation.navigate("Signin",{signupData});
